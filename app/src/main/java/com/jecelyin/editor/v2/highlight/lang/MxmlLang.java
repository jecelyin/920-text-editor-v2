 ...
 */
public class MxmlLang implements LangDefine {
    ...
    private RULES RULES2() {
        RULES RULES1 = new RULES();
        RULES1.SET = "ACTIONSCRIPT";
        RULES1.DEFAULT = "MARKUP";
        RULES1.IGNORE_CASE = "FALSE";
        SEQ SEQ1 = new SEQ();
        SEQ1.text = "[";
        SEQ1.TYPE = "KEYWORD2";
        SEQ1.DELEGATE = "actionscript::MAIN";
...
        KEYWORDS1.add("KEYWORD1", new String[]{"EMPTY", "INCLUDE", "IGNORE", "NDATA", "#IMPLIED", "#PCDATA", "#REQUIRED", });

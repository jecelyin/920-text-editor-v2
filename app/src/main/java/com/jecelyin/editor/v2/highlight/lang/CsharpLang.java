 ...
 */
public class CsharpLang implements LangDefine {
    ...
    private RULES RULES1() {
        ...
        KEYWORDS1.add("KEYWORD1", new String[]{"abstract", "alias", "as", "base", "break", "case", "catch", "checked", "const", "continue", "decimal", "default", "delegate", "do", "else", "explicit", "extern", "finally", "fixed", "for", "foreach", "from", "goto", "if", "implicit", "in", "internal", "is", "lock", "new", "operator", "out", "override", "params", "partial", "private", "protected", "public", "readonly", "ref", "return", "sealed", "select", "sizeof", "stackalloc", "static", "switch", "throw", "try", "typeof", "unchecked", "unsafe", "virtual", "while", "where", "yield", });
        KEYWORDS1.add("KEYWORD2", new String[]{"using", "namespace", });
        KEYWORDS1.add("KEYWORD3", new String[]{"bool", "byte", "char", "class", "double", "dynamic", "enum", "event", "float", "int", "interface", "long", "object", "sbyte", "short", "string", "struct", "uint", "ulong", "ushort", "var", "void", });
        RULES1.MARK_PREVIOUS = new MARK_PREVIOUS[] { MARK_PREVIOUS1, };

        RULES1.EOL_SPAN = new EOL_SPAN[] { EOL_SPAN1, EOL_SPAN2, EOL_SPAN3, EOL_SPAN4, EOL_SPAN5, EOL_SPAN6, EOL_SPAN7, EOL_SPAN8, EOL_SPAN9, EOL_SPAN10, EOL_SPAN11, EOL_SPAN12, EOL_SPAN13, };

...
public class AvroLang implements LangDefine {
    ...
    private RULES RULES1() {
        ...
        SEQ SEQ11 = new SEQ();
        SEQ11.text = "import idl";
        SEQ11.TYPE = "KEYWORD2";
        SEQ SEQ12 = new SEQ();
        SEQ12.text = "import protocol";
        SEQ12.TYPE = "KEYWORD2";
        SEQ SEQ13 = new SEQ();
        SEQ13.text = "import schema";
        SEQ13.TYPE = "KEYWORD2";
        KEYWORDS KEYWORDS1 = new KEYWORDS();
        KEYWORDS1.add("KEYWORD2", new String[]{"throws", "oneway", "map", });
        KEYWORDS1.add("KEYWORD3", new String[]{"array", "boolean", "bytes", "double", "enum", "error", "fixed", "float", "int", "long", "protocol", "record", "string", "union", "void", });
        KEYWORDS1.add("KEYWORD4", new String[]{"null", "true", "false", });

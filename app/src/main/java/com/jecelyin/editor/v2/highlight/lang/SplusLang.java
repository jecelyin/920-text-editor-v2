...
public class SplusLang implements LangDefine {
        ...
        PROPERTY7.NAME = "contextInsensitive";
    ...
    private RULES RULES1() {
        ...
        KEYWORDS1.add("KEYWORD1", new String[]{"break", "case", "continue", "default", "do", "else", "for", "goto", "if", "return", "sizeof", "switch", "while", "function", });

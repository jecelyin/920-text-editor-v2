...
        KEYWORDS1.add("KEYWORD1", new String[]{"Block", "Buffer", "CFunction", "Date", "Duration", "File", "Future", "List", "LinkedList", "Map", "Nop", "Message", "Nil", "Number", "Object", "String", "WeakLink", "block", "method", });

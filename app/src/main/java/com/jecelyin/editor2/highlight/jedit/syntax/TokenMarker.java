...
package com.jecelyin.editor2.highlight.jedit.syntax;

//{{{ Imports

import com.jecelyin.editor2.highlight.jedit.util.TextUtilities;
import com.jecelyin.editor2.highlight.jedit.Segment;
import com.jecelyin.editor2.highlight.jedit.util.SegmentCharSequence;
